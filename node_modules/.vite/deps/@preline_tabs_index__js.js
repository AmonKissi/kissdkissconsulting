  ...
  "node_modules/@preline/tabs/index.js"(exports, module) {
    !function(t, e) {
      ...
      var t = { 190: (t2, e2) => {
        ...
        Object.defineProperty(e2, "__esModule", { value: true });
        var s = n2(969), a = i(n2(737)), l = n2(190), c = function(t3) {
          function e3(e4, n3, o2) {
            var r2 = t3.call(this, e4, n3, o2) || this;
            return r2.toggles = r2.el.querySelectorAll("[data-hs-tab]"), r2.extraToggleId = r2.el.getAttribute("hs-data-tab-select"), r2.extraToggle = document.querySelector(r2.extraToggleId), r2.current = Array.from(r2.toggles).find(function(t4) {
        ...
        e2.isEnoughSpace = function(t3, e3, n3, o2, r) {
          void 0 === n3 && (n3 = "auto"), void 0 === o2 && (o2 = 10), void 0 === r && (r = null);
          var i = e3.getBoundingClientRect(), s = r ? r.getBoundingClientRect() : null, a = window.innerHeight, l = s ? i.top - s.top : i.top, c = (r ? s.bottom : a) - i.bottom, u = t3.clientHeight + o2;
