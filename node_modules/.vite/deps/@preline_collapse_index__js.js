    ...
    !function(t, e) {
      ...
      var t = { 737: (t2, e2) => {
        ...
        var r = n2(969), l = function(t3) {
          ...
          return i(e3, t3), e3.prototype.init = function() {
            ...
            this.animationInProcess = true, this.el.classList.add("open"), this.content.classList.add("open"), this.content.classList.remove("hidden"), this.content.style.height = "0", setTimeout(function() {
              t4.content.style.height = "".concat(t4.content.scrollHeight, "px"), t4.fireEvent("beforeOpen", t4.el), (0, r.dispatch)("beforeOpen.hs.collapse", t4.el, t4.el);
        ...
        e2.isEnoughSpace = function(t3, e3, n3, o2, i) {
          ...
          var s = e3.getBoundingClientRect(), r = i ? i.getBoundingClientRect() : null, l = window.innerHeight, c = r ? s.top - r.top : s.top, a = (i ? r.bottom : l) - s.bottom, u = t3.clientHeight + o2;
